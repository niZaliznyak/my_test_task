...
describe("setNewQuotes action creator", () => {
...
it("stoped qoutes must being in actualQuotes", () => {

    let newState = mainReducer(testState, getStopQuotesAction);
    expect(newState.actualQuotes[2]).toStrictEqual({difference: "UP", isStoped: true, price: "180.48", ticker: "MSFT"});
});
